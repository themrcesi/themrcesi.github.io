        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12">
            <div className='space-y-4'>
              ...
              <p className="text-sm sm:text-base md:text-lg leading-relaxed text-gray-300 text-justify">
                In addition to my full-time role, I&apos;m actively seeking side projects where I can apply my technical knowledge and expertise. If you have a project that could benefit from my skills in data science, AI, or software engineering, I&apos;d love to hear about it. Feel free to use the scheduling tool in the <a href="#contact" className="text-blue-400 hover:underline" onClick={(e) => { e.preventDefault(); document.querySelector('#contact')?.scrollIntoView({ behavior: 'smooth' }); }}>contact section</a> to book a time for us to discuss potential collaborations.
              </p>
            </div>
            <div>
